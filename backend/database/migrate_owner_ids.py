...
def migrate_owner_ids():
    ...
    try:
        ...
        try:
            ...
            print("  [.] Lead string columns already removed.")
        ...
        try:
            ...
            print("  [.] Company string columns already removed.")
        ...
        try:
            ...
            print("  [.] Contact string columns already removed.")
        ...
        try:
            ...
            print("  [.] Deal string columns already removed.")
